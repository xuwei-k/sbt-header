...
class LicenseDetectionSpec extends AnyWordSpec with Matchers {
  ...
  val licenses: Map[License, (String, URL)] = Map(
    BSD2Clause(yyyy.toString, organizationName) -> (
      "BSD-2-Clause",
      url(
        "https://spdx.org/licenses/BSD-2-Clause.html#licenseText"
      )
    ),
    BSD3Clause(yyyy.toString, organizationName) -> (
      "BSD-3-Clause",
      url(
        "https://spdx.org/licenses/BSD-3-Clause.html#licenseText"
      )
    ),
    AGPLv3OrLater(yyyy.toString, organizationName) -> (
      "AGPL-3.0-or-later",
      url(
        "https://spdx.org/licenses/AGPL-3.0-or-later.html#licenseText"
      )
    ),
    AGPLv3Only(yyyy.toString, organizationName) -> (
      "AGPL-3.0-only",
      url(
        "https://spdx.org/licenses/AGPL-3.0-only.html#licenseText"
      )
    ),
    AGPLv3(yyyy.toString, organizationName) -> (
      "AGPL-3.0",
      url(
    ...
    MPLv2(yyyy.toString, organizationName) -> (
      "MPL-2.0",
      url(
